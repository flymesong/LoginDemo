...
//		String clock = request.getParameter("clock");//时间 
		String backUri = "&clock="+strBeginDate;
		backUri = URLEncoder.encode(backUri);
		String url = HttpUrl.SetStatus_Url;//控锁状态
		url = MathsUtil.getEncryptionValuePair(StringsUtil.urlParse(url))+"&mobileno="+mobileno+"&getwaystate="+getwaystate+"&channel="+channel+"&voltage="+voltage+"&fusestatus="+fusestatus+"&sensitivity="+sensitivity+"&lockstate="+lockstate+"&berthstate="+berthstate+"&mode="+mode+"&deviceno="+deviceno+"&fwver="+fwver+"&hwver="+hwver+backUri;
